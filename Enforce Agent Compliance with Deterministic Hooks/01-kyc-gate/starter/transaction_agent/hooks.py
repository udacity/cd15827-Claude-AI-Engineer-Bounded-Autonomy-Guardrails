...
In this exercise you implement ``kyc_prerequisite_hook``: the programmatic prerequisite that
...
def kyc_prerequisite_hook(call: ToolCall, state: SessionState) -> HookDecision:
    ...
    """
    # TODO US-01 (LO-2): If call.name is one of MONEY_MOVEMENT_TOOLS, look up the call's
